...
fun PlantDetailContent(plant: Plant) {
    Surface {
        Column(Modifier.padding(dimensionResource(id = R.dimen.margin_small))) {
            ...
            PreviewDescription(description = plant.description)
        }
    }
}
...
@Composable
fun PreviewDetailContentPreview() {
...
@Composable
fun PreviewDescription(description: String) {
...
@Preview(showBackground = true)
@Composable
fun PreviewDescriptionPreview() {
    MdcTheme {
        PreviewDescription("HTML<br><br>description")
    }
}
